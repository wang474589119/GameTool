...
using SYSTEMTIME = System.DateTime;
...
namespace IslandTool
{
    ...
    public struct CPINFO
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Kernel32Api.MAX_DEFAULTCHAR)] public byte[] DefaultChar;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Kernel32Api.MAX_LEADBYTES)] public byte[] LeadByte;
    }
    ...
    public struct WIN32_FIND_DATA
    {
        ...
        public int dwReserved1;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Kernel32Api.MAX_PATH)]
    ...
    public abstract class Kernel32Api
    {
